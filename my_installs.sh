...
sudo pacman -S --needed atom bleachbit cmatrix compton dropbox gparted i3-gaps i3blocks i3lock i3status iptables dmenu gimp libnotify nftables npm rofi telegram-desktop wireshark-qt yaourt xf86-video-intel xf86-video-nouveau
yaourt -S --needed neofetch twmn-git musixmatch-bin polybar-git spotify signal-desktop-bin
